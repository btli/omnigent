"""Tests for subscription-token use cases and the selection policy (in-memory fakes)."""
...
from omnigent.subscription_tokens.domain.value_objects.enums import FailoverMode
