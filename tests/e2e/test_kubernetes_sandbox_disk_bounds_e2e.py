...
_CAPTURE_ENV_VAR = "OMNIGENT_TEST_K8S_CAPTURE_FILE"

_HEALTH_TIMEOUT_S = 180.0
_MANIFEST_TIMEOUT_S = 120.0
_POLL_INTERVAL_S = 0.5

# Stub of the optional ``kubernetes`` client, generated into tmp_path and put
# on the SERVER subprocess's PYTHONPATH. It satisfies the SDK surface the
...
_STUB_FILES: dict[str, str] = {
    ...
    "kubernetes/client/__init__.py": (
        ...
        f'    path = os.environ.get("{_CAPTURE_ENV_VAR}")\n'
        "    if not path:\n"
        "        return\n"
        "    records = []\n"
