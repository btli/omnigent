"""Shared atomic-UPSERT helper for the subscription-token SQLAlchemy adapters.

Several subscription-token writes (config→DB sync of pools/accounts, session bindings)
