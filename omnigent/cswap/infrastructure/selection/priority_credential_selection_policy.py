...
:class:`~omnigent.cswap.domain.value_objects.limit_state.LimitState` and
delegates the choice to the pure
:class:`~omnigent.cswap.domain.value_objects.rotation_policy.RotationPolicy`.
...
from omnigent.cswap.domain.value_objects.rotation_policy import RotationPolicy
