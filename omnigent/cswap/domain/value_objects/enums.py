"""Shared literal enums for the multi-subscription (cswap) domain.

These are the small closed vocabularies used across the cswap value
...
#: How a :class:`~omnigent.cswap.domain.value_objects.limit_state.LimitState`
