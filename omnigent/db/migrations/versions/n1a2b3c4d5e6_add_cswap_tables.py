"""add multi-subscription (cswap) tables
...
unaffected: the cswap code paths only touch them when a pool is
configured.
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("window_5h_pct", sa.Integer(), nullable=True),
        sa.Column("window_7d_pct", sa.Integer(), nullable=True),
        sa.Column("reset_at_5h", sa.Integer(), nullable=True),
        sa.Column("reset_at_7d", sa.Integer(), nullable=True),
