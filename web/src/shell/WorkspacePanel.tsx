...
function WorkspacePanelImpl({
  ...
  return (
    <aside
      ...
      className={cn(
        "@container/rail relative z-40 hidden md:flex md:min-h-0 md:flex-row md:border-l md:border-border md:bg-card",
    ...
    >
      {/* The resize target stays inside the Workspace landmark while its
          sibling body owns clipping for both scroll containers. */}
      ...
      <div data-workspace-panel-body className="flex min-w-0 flex-1 flex-col overflow-hidden">
