...
object NativeBridgeScript {
    ...
    internal val insetStyles: String =
        ...
        @media (width < 48rem){:is(.conversations-sidebar,[data-testid="execution-logs-panel"],[data-testid="file-viewer"],[data-testid="files-panel-drawer"],[data-testid="terminals-panel"],[data-testid="shells-panel-drawer"],[data-testid="subagents-panel-drawer"],[data-testid="todos-panel-drawer"]){padding-top:var(--omnigent-safe-top, 0px) !important;padding-bottom:var(--omnigent-safe-bottom, 0px) !important;padding-left:var(--omnigent-safe-left, 0px) !important;padding-right:var(--omnigent-safe-right, 0px) !important}}
