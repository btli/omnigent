 ...
 * inline and every other origin keeps its RFC 8252 system-browser flow. A landing
 * on a bare Databricks workspace root is bounced to the workspace's `/omnigent`
