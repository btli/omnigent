...
class MainActivity : AppCompatActivity() {
    ...
    // Robolectric cannot expose AndroidX WebKit's secure bridge features.
    @VisibleForTesting
    internal var requireSecureBridge = true
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        installBridge()
        if (!bridgeTransportInstalled && requireSecureBridge) {
